...
const roofingCreatives = [
  { file: '1 Before and After.png', label: 'North City Roofing', sub: 'Full roof transformation — before & after' },
  { file: '2 Before and After.jpg', label: 'North City Roofing', sub: 'Before & after comparison' },
  { file: '3 Before and After.png', label: 'North City Roofing', sub: 'Storm damage repair — before & after' },
  { file: '4 Before and After.png', label: 'North City Roofing', sub: 'Gutter replacement — before & after' },
  { file: '5 Before and After.jpg', label: 'North City Roofing', sub: 'Commercial roofing — before & after' },
  { file: '6 - Testimonial.png', label: 'North City Roofing', sub: 'Google rating showcase' },
  { file: '7 Testimonial.jpg', label: 'North City Roofing', sub: 'Customer testimonial' },
  { file: '10 Testimonial.jpg', label: 'North City Roofing', sub: 'Neighborhood testimonial' },
  { file: '11 Urgency.jpg', label: 'North City Roofing', sub: 'Storm damage urgency ad' },
  { file: '12 Urgency.jpg', label: 'North City Roofing', sub: 'Warning-sign urgency ad' },
  { file: '13 Urgency.jpg', label: 'North City Roofing', sub: 'Storm-front urgency ad' },
  { file: '14 Urgency.jpg', label: 'North City Roofing', sub: '24/7 emergency repair ad' },
  { file: '15 Urgency.jpg', label: 'North City Roofing', sub: 'Storm-ready urgency ad' },
  { file: '16 Educational.jpg', label: 'North City Roofing', sub: 'Educational roofing content' },
  { file: '17 Educational.jpg', label: 'North City Roofing', sub: 'Educational roofing content' },
  { file: '18 Educational.jpg', label: 'North City Roofing', sub: 'Educational roofing content' },
  { file: '19 Educational.jpg', label: 'North City Roofing', sub: 'Educational roofing content' },
  { file: '22 Offer.jpg', label: 'North City Roofing', sub: 'Special offer creative' },
  { file: '23 Offer.jpg', label: 'North City Roofing', sub: 'Special offer creative' },
  { file: '24 Offer.jpg', label: 'North City Roofing', sub: 'Special offer creative' },
  { file: '25 Offer.jpg', label: 'North City Roofing', sub: 'Special offer creative' },
  { file: '27 Local.jpg', label: 'North City Roofing', sub: 'Local trust / crew showcase' },
  { file: '28 Local.jpg', label: 'North City Roofing', sub: 'Local trust / service area' },
  { file: '30 Local.jpg', label: 'North City Roofing', sub: 'Local trust signal' },
  { file: '33 Carousel.jpg', label: 'North City Roofing', sub: 'Carousel post — free estimate' },
  ...
  { file: 'Meme Post/1 Meme.jpg', label: 'North City Roofing', sub: 'Meme post' },
  { file: 'Meme Post/2 Meme.jpg', label: 'North City Roofing', sub: 'Meme post' },
  { file: 'Meme Post/3 Meme.jpg', label: 'North City Roofing', sub: 'Meme post' },
  { file: 'Meme Post/4 Meme.png', label: 'North City Roofing', sub: 'Meme post' },
  { file: 'Meme Post/5 Meme.jpg', label: 'North City Roofing', sub: 'Meme post' },
  { file: 'Meme Post/6 Meme.jpg', label: 'North City Roofing', sub: 'Meme post' },
  { file: 'Meme Post/7 Meme.jpg', label: 'North City Roofing', sub: 'Meme post' },
  { file: 'Meme Post/8 Meme.jpg', label: 'North City Roofing', sub: 'Meme post' },
  { file: 'Meme Post/9 Meme.jpg', label: 'North City Roofing', sub: 'Meme post' },
  { file: 'Meme Post/10 Meme.jpg', label: 'North City Roofing', sub: 'Meme post' },
  { file: 'Meme Post/11 Meme.jpg', label: 'North City Roofing', sub: 'Meme post' },
  { file: 'Meme Post/12 Meme.jpg', label: 'North City Roofing', sub: 'Meme post' },
];
